...
export const upVote = (id) => {
  return axios.post(`http://localhost:3001/posts/${id}`,
    {
      option: 'upVote'
    },
    {
...
export const upVoteComment = (id) => {
  return axios.post(`http://localhost:3001/comments/${id}`,
    {
      option: 'upVote'
    },
    {
...
export const saveComment = (comment) => {
  return axios.put(`http://localhost:3001/comments/${comment.id}`,
    {
...
export const savePost = (post) => {
  return axios.put(`http://localhost:3001/posts/${post.id}`,
    {
      ...post
    },
    {
